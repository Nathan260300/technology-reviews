console.log("%c© 2025 - Moad The Coder", "background: #282c34; color: #98c379; padding: .5em 1em; border-radius: 5px; font-weight: bold;");
...
console.log("%cMade with 🕑 and 💖 by Moad – Last update : 22/10/2025","background: #282c34; color: #c678dd; padding: .5em 1em; border-radius: 5px; font-weight: bold;")
